...
class EncounterItemSerializer(serializers.Serializer):
    ...
    period_start = serializers.DateTimeField(allow_null=False, input_formats=[settings.DATE_TIME_FORMAT_TIMEZONE], required=True)
    period_end = serializers.DateTimeField(allow_null=False, input_formats=[settings.DATE_TIME_FORMAT_TIMEZONE], required=True)
    period_in_progress = serializers.DateTimeField(allow_null=False, input_formats=[settings.DATE_TIME_FORMAT_TIMEZONE], required=True)
...
class ConditionItemSerializer(serializers.Serializer):
    ...
    clinical_status_tb = serializers.ChoiceField(
        choices=list(data_condition_clinical_status().keys()),
        allow_null=False, allow_blank=False, required=False
    )
...
class MedicationItemSerializer(serializers.Serializer):
    kfa_code = serializers.CharField(max_length=255, allow_blank=False, allow_null=False, required=False)
...
class EpisodeOfCareItemSerializer(serializers.Serializer):
    ...
    period_start = serializers.DateTimeField(allow_null=True, input_formats=[settings.DATE_TIME_FORMAT_TIMEZONE], required=True)
    period_end = serializers.DateTimeField(allow_null=True, input_formats=[settings.DATE_TIME_FORMAT_TIMEZONE], required=False)
...
class ObservationItemSerializer(serializers.Serializer):
    ...
    issued = serializers.DateTimeField(allow_null=False, input_formats=[settings.DATE_TIME_FORMAT_TIMEZONE], required=True)
    issued_rifampicin = serializers.DateTimeField(allow_null=True, input_formats=[settings.DATE_TIME_FORMAT_TIMEZONE], required=False)
...
class PatientItemSerializer(serializers.Serializer):
    ...
    province = serializers.CharField(max_length=255, allow_blank=True, allow_null=False, required=False)
    district = serializers.CharField(max_length=255, allow_blank=True, allow_null=False, required=False)
    address = serializers.CharField(max_length=255, allow_blank=True, allow_null=False, required=False)
...
class TransactionSitbCreateSerializer(serializers.Serializer):
    ...
    organization_id = serializers.CharField(max_length=255, allow_blank=True, allow_null=False, required=False)
    location_id = serializers.CharField(max_length=255, allow_blank=True, allow_null=False, required=False)
    practitioner_nik = serializers.DecimalField(max_digits=16, decimal_places=0, allow_null=False, required=False)
    patient = PatientItemSerializer(required=True)
    encounter = EncounterItemSerializer(required=False)
    questionnaire_response = QuestionnaireResponseItemSerializer(required=False)
    condition = ConditionItemSerializer(required=True, many=True)
    medication = MedicationItemSerializer(required=False, many=True)
    observation = ObservationItemSerializer(required=False, many=True)
